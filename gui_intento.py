...
def open_new_window():
    ...
    global pantalla_20_image, back_image, extraer_image  
    ...
    extraer_image = PhotoImage(file=extraer_image_path)
    extraer_button = Button(new_window, image=extraer_image, bg="#FFFFFF", bd=0, command=initiate_scraping)
    extraer_button.place(x=900, y=630)
    # Label ventana nueva
